...
NETWORK_ARGS := --rpc-url http://localhost:8545 --account $(anvilAcount) --sender 0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266  --broadcast
...
# ifeq ($(findstring --network sepolia,$(ARGS)),--network sepolia)
# 	NETWORK_ARGS := --rpc-url $(SEPOLIA_RPC_URL) --private-key $(DEFAULT_SEPOLIA_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
# endif
